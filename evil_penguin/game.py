...
class Game:
    ...
    def is_valid_guess(string):
        ...
        # TODO: implement me
        # NOTE: you will need to change the return statement below
    ...
    def get_indices(word, char):
        ...
        This function should be called in `create_word_buckets`.
        ...
        # TODO: fill in the space here. You should use a for loop and an if statement
        # HINT: look at the enumerate function
    ...
    def get_new_discovered_letters(discovered_letters, indices, guess):
        ...
        # TODO: fill in code here, you will want to use a for loop
    ...
    def get_robot_ascii(num_incorrect_guesses):
        ...
        # TODO: implement me
        # HINT: you will want to use an if statement 
